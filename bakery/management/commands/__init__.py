...
def get_bucket_page(page: object) -> object:
    """
    ...
    return {k.get("Key"): k for k in key_list}


def get_all_objects_in_bucket(
    aws_bucket_name: object, s3_client: object = None, max_keys: object = 1000
) -> object:
    """
...
class BasePublishCommand(BaseCommand):
    ...
    def get_s3_client(self) -> object:
        return get_s3_client()

    def get_all_objects_in_bucket(self, *args: object, **kwargs: object) -> object:
        return get_all_objects_in_bucket(*args, **kwargs)

    def batch_delete_s3_objects(self, *args: object, **kwargs: object) -> object:
